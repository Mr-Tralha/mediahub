          ...
          <div className="max-w-3xl mx-auto bg-yellow-50 border border-yellow-200 rounded-lg p-4">
            <div className="flex items-start space-x-3">
              ...
              <div className="flex-1">
                <h3 className="text-sm font-medium text-yellow-800">Armazenamento em Memória</h3>
                <p className="mt-1 text-sm text-yellow-700">
                  Posts são mantidos apenas enquanto o servidor estiver ativo. Use o botão "Salvar JSON" para guardar permanentemente.
                </p>
              </div>
            </div>
          </div>
